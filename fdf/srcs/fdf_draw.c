...
/*   Updated: 2020/06/27 17:49:16 by lcassaun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int 	draw_line(t_mlx *mlx)
{
	...
	z1 *= (float)((float)mlx->zoom_z + (float)((float)mlx->zoom / (float)mlx->zoom_z));
	z2 *= (float)((float)mlx->zoom_z + (float)((float)mlx->zoom / (float)mlx->zoom_z));
	isometric(mlx, z1, z2);

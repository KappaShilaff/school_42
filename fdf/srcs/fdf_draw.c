...
{
	mlx->x1 = (float)((mlx->x1 - mlx->y1) * cos(mlx->cos));
	mlx->y1 = (float)((mlx->x1 + mlx->y1) * sin(mlx->sin) - z1);
	mlx->x2 = (float)((mlx->x2 - mlx->y2) * cos(mlx->cos));
	mlx->y2 = (float)((mlx->x2 + mlx->y2) * sin(mlx->sin) - z2);
}
